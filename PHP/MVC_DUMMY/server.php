...
$master  = WebSocket("diplom.massique.com",25);
...
function WebSocket($address,$port){
  $master=socket_create(AF_INET, SOCK_STREAM, 0)     or die("socket_create() failed");
  socket_set_option($master, SOL_SOCKET, SO_REUSEADDR, 1)  or die("socket_option() failed");
 // if(!socket_connect($master, 'diplom.massique.com', 8888)) die ("FAIL");
  socket_connect($master, $address, $port)                    or die("socket_bind() failed");
  $i = 0;
  socket_listen($master) or die("failed");
