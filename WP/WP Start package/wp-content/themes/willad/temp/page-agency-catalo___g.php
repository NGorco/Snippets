                        ...
                        <article id="article-post" class="cat-sports">
    	                    ...
    	                    <section id="agencies-catalog" class="module-timeline">
                                ...
                                <ul class="agencies-cats">
                                    <li><a href="#" class="btn btn-default">Рекламные агентства</a></li>
                                    <li><a href="#" class="btn btn-default">Digital-агентства</a></li>
                                    <li><a href="#" class="btn btn-default">Медиапровайдеры</a></li>
                                    <li><a href="#" class="btn btn-default">Производство рекламы</a></li>
                                </ul>
                                <div class="results-header">
                                    По вашему запросу найдено 1833 агентства                 
                                </div>
                                <div class="articles">
                                    <article>
