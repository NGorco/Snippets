...
if (!is_admin()) 
{
	...
	wp_enqueue_style('fix-styles', TPL . '/css/fix_styles.css');
...
add_shortcode('show-post', 'show_post');

function custom_wp_query($args = Array(), $template = ''){
...
function get_meta($meta_code, $ID = '')
{
	global $post;
